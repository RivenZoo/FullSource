...
METHODDEF(boolean_def) compress_data
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#ifdef FULL_COEF_BUFFER_SUPPORTED
METHODDEF(boolean_def) compress_first_pass
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
METHODDEF(boolean_def) compress_output
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#endif
...
GLOBAL(void)
jinit_c_coef_controller (j_compress_ptr cinfo, boolean_def need_full_buffer)
{
  my_coef_ptr coef;
