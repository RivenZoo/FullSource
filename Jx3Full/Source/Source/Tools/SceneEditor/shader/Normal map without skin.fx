...
{ 
    ...
    PixelShader = compile ps_2_0 f(colorTextureSampler, SpecularMapSampler, AmbientMapSampler, ambient,surfColor,specularColor,shininess,lightDiffuse);
    }
}
