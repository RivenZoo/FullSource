<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="RoleDetail.aspx.cs" Inherits="GameMaster_RoleDetail" MaintainScrollPositionOnPostback="true" Title="<%$ Resources:StringDef, RoleDetail %>" %>
