<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="QueryRole.aspx.cs" Inherits="GameMaster_QueryRole" Title="<%$ Resources:StringDef, QueryRole %>" %>
