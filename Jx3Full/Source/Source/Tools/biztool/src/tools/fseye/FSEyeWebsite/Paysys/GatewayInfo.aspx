<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="GatewayInfo.aspx.cs" Inherits="Paysys_GatewayList" Title="<%$ Resources: StringDef, GatewayInfo %>" %>
