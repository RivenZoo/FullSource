<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="BatchTask.aspx.cs" Inherits="BatchTask_BatchTask" Title="<%$ Resources:StringDef, BatchTask %>" %>
