...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=17742 DEFAULT CHARSET=gb2312;
...
#
# Data for the `server_region` table  (LIMIT 0,500)
#

INSERT INTO `server_region` (`ID`, `MaxPlayers`, `MaxPlayersLogTime`, `RegionName`, `RegionType`) VALUES 
  (1,0,NULL,'root',0),
  (2,0,NULL,'directUnder',1);
...
INSERT INTO `system_log` (`ID`, `OPERATOR`, `OPERATION`, `TARGET`, `DESCRIPTION`, `LOGTIME`) VALUES 
  (17741,6,2,14,'[blaze]从[192.168.20.74]登入系统','2008-07-10 23:04:59');
