...
public class accountnctrl$jsp extends HttpJspBase {


    static {
    }
    public accountnctrl$jsp( ) {
    }
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(0,176);to=(1,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(1,57);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(2,56);to=(3,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(3,54);to=(4,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(4,62);to=(5,0)]
                out.write("\r\n");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(5,0);to=(5,47)]
                /* ----  power:checkpower ---- */
                ...
                _jspx_th_power_checkpower_0.setModulecode("4accountnctrl");
                try {
            ...
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(5,47);to=(12,0)]
                out.write("\r\n<html>\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n<title>帐号一般控制</title>\r\n<link href=\"../css/public.css\" rel=\"stylesheet\" type=\"text/css\">\r\n<script language=\"JavaScript\" src=\"../js/public.js\"></script>\r\n");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(12,2);to=(24,0)]
            ...
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(24,2);to=(26,13)]
                out.write("\r\n<script language=\"javascript\">\r\nvar AbsPath=\"");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(26,16);to=(26,40)]
                out.print(request.getContextPath());
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(26,42);to=(85,16)]
            ...
            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(85,19);to=(85,26)]
                out.print(command);
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(85,28);to=(86,16)]
                out.write("\";\r\n\tvar game_id = \"");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(86,19);to=(86,26)]
                out.print(game_id);
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(86,28);to=(126,44)]
            ...
            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(126,47);to=(126,71)]
                out.print(request.getContextPath());
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(126,73);to=(127,45)]
                out.write("/GMCServlet\">\r\n\t<input type=\"hidden\" name=\"usercode\" value=\"");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(127,48);to=(127,70)]
                out.print(userinfo.getUsercode());
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(127,72);to=(136,14)]
            ...
            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(136,14);to=(136,109)]
                ...
                _jspx_th_function_functionSelect_0.setDisplayCode("select_a_n_ctrl");
            ...
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(136,109);to=(140,14)]
                out.write("</td>\r\n        </tr>\r\n        <tr>\r\n          <td width=\"132\" height=\"30\" align=\"right\" nowrap><font color=\"#FF0000\">*</font>所属游戏：</td>\r\n          <td>");

            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(140,14);to=(140,97)]
                /* ----  game:gameselect ---- */
            ...
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(140,97);to=(149,6)]
            ...
            // end
            // begin [file="/gmc/accountnctrl.jsp";from=(149,6);to=(149,105)]
                /* ----  display:display ---- */
                ...
                try {
                    ...
                    if (_jspx_eval_display_display_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                        // end
                        // HTML // begin [file="/gmc/accountnctrl.jsp";from=(149,105);to=(150,12)]
                            out.write("\r\n            ");

                        // end
                        // begin [file="/gmc/accountnctrl.jsp";from=(150,12);to=(150,30)]
            ...
            // end
            // HTML // begin [file="/gmc/accountnctrl.jsp";from=(150,30);to=(201,0)]
