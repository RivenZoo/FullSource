<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_Console, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, Console %>" theme="BlazeSky" %>
