<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_AdvancedPlayerCount, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, AdvancedPlayerCount %>" theme="BlazeSky" %>
