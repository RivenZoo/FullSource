<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Security_UserPassword, App_Web_jztwgtrl" title="<%$ Resources:StringDef,UserPassword %>" theme="BlazeSky" %>
