<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Security_EditUser, App_Web_jztwgtrl" title="<%$ Resources:StringDef, EditUser %>" theme="BlazeSky" %>
