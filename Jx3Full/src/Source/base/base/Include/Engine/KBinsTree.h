...
#ifndef _ENGINE_BINARY_SEARCH_TREE_H_
#define _ENGINE_BINARY_SEARCH_TREE_H_
...
template <class T>
BinSTree<T>::BinSTree():root(NULL), current(NULL), size(0)
{}
...
#endif  // _ENGINE_BINARY_SEARCH_TREE_H_
