========================================================================
    ACTIVE TEMPLATE LIBRARY : MeshMdlExt Project Overview
========================================================================

AppWizard has created this MeshMdlExt project for you to use as the starting point for
...
MeshMdlExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MeshMdlExt.h)
        GUID definitions                                (MeshMdlExt_i.c)
        A type library                                  (MeshMdlExt.tlb)
        Marshaling code                                 (MeshMdlExt_p.c and dlldata.c)

MeshMdlExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MeshMdlExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named MeshMdlExt.pch and a precompiled types file named StdAfx.obj.
...
MeshMdlExtps.vcproj
	...
	dlldata.c, MeshMdlExt_i.c and MeshMdlExt_p.c which are required
