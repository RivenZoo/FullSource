...
$Id: SynEditPrintTypes.pas,v 1.1 2005/06/20 03:13:17 zhujianqiu Exp $
...
begin
  ...
  begin
    Found := (Pos > MaxCol) and (WrapPos.Index <> 0);
    ...
    begin
      ...
      if ((Length(Line) - WrapPos.Index) > MaxCol) and (Pos < Length(Line)) then
        WrapPos := TWrapPos.Create
      else
        Break;
    end;
