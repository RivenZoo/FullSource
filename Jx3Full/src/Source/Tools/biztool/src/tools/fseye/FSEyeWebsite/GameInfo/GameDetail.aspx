<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="GameDetail.aspx.cs" Inherits="GameInfo_GameDetail" Title="<%$ Resources:StringDef, GameInfo %>" %>
