<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AccountState.aspx.cs" Inherits="Paysys_AccountState" Title="<%$ Resources: StringDef, AccountState %>" %>
