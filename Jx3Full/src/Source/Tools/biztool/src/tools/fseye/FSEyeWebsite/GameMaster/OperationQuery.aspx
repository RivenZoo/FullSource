<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="OperationQuery.aspx.cs" Inherits="GameMaster_OperationQuery" Title="<%$ Resources:StringDef,GMOperationQuery %>" %>
