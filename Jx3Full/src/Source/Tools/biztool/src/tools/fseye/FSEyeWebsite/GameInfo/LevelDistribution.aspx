<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Common/Main.master" CodeFile="LevelDistribution.aspx.cs" Inherits="GameInfo_LevelDistribution" %>
...
<table width="100%">
	<tr>
		<td align="center" colspan="4">
			<asp:Label ID="literal3" runat="server" Text="<%$ Resources:StringDef, LevelDistribution %>" SkinID="Title" />
		</td>
	</tr>
	...
	<tr>
		<td align="center">
			<asp:Table ID="Table1" runat="server">
				...
				<asp:TableRow>
				    ...
				    <asp:TableCell>				    
                        <asp:DropDownList ID="DropDownListSex" runat="server">
                        	<asp:ListItem Text="<%$ Resources:StringDef,All %>" Selected="true" />
	                        <asp:ListItem Text="<%$ Resources:StringDef,Male %>" />
	                        <asp:ListItem Text="<%$ Resources:StringDef,Female %>" />
	                    </asp:DropDownList>
				    </asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
				    <asp:TableHeaderCell>
				        <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:StringDef,ActivePlayer %>" />
				    </asp:TableHeaderCell>
				    <asp:TableCell>
				...
				<asp:TableRow>
				    <asp:TableHeaderCell>
				        <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:StringDef,SocialRelation %>" />
				    </asp:TableHeaderCell>
				    <asp:TableCell>
				...
				<asp:TableRow>
				    <asp:TableHeaderCell>
				        <asp:Literal runat="server" Text="<%$ Resources:StringDef,Group %>" />
				    </asp:TableHeaderCell>
				    <asp:TableCell>
				        <asp:TextBox runat="server" ID="TextBoxGroup" Text="10" />
				    </asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
				    <asp:TableHeaderCell>
				        <asp:Literal runat="server" Text="<%$ Resources:StringDef,ChartType %>" />
				    </asp:TableHeaderCell>
				    <asp:TableCell>
				        <asp:DropDownList runat="server" ID="DropDownListBarType">				        
				            <asp:ListItem Text="Stack" Selected="true" />
				            <asp:ListItem Text="PercentStack" />		
				            <asp:ListItem Text="Cluster" />
				            <asp:ListItem Text="ClusterHiLow" />
				            <asp:ListItem Text="Overlay" />
				            <asp:ListItem Text="SortedOverlay" />		            
				        </asp:DropDownList>
				    </asp:TableCell>
				</asp:TableRow>
			</asp:Table>
...
<table width="100%">
	...
	<tr>
	    <td>
	        <zgw:ZedGraphWeb runat="server" OnRenderGraph="ZedGraphWebLevelSuiStatistic_RenderGraph" Width="840" Height="400" />
	    </td>
	</tr>
	</asp:Panel>
	<tr class="TableRowSpacing" />
