<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="IBShop.aspx.cs" Inherits="GameMaster_IBShop" ValidateRequest="false" EnableViewState="false" Title="<%$ Resources:StringDef,IBShop %>" %>
