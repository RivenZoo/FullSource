<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameInfo_Item, App_Web_d99p0fdh" title="<%$ Resources:StringDef,Item %>" theme="BlazeSky" %>
