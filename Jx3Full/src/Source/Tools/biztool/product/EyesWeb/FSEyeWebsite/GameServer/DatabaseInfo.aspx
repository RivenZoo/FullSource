<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_DatabaseInfo, App_Web_jvyc5ygz" title="<%$ Resources:StringDef,DatabaseInfo %>" theme="BlazeSky" %>
