<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Security_UserGroup, App_Web_jztwgtrl" title="<%$ Resources:StringDef, UserInGroup %>" theme="BlazeSky" %>
