<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_EditServerGroup, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, EditServer %>" theme="BlazeSky" %>
