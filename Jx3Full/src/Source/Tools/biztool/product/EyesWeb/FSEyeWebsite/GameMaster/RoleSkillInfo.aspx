<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameMaster_RoleSkillInfo, App_Web_6lmf-asn" title="<%$ Resources:StringDef,SkillInfo %>" theme="BlazeSky" %>
