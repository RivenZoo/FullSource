<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Paysys_GatewayList, App_Web_ipk8xfvi" title="<%$ Resources: StringDef, GatewayInfo %>" theme="BlazeSky" %>
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <asp:Label ID="LabelTitle" runat="server" Text="<%$ Resources: StringDef, GatewayInfo %>" SkinID="Title" />
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
		<td align="center">						
			...
			<asp:LinkButton ID="LinkButtonUpdateGateway" runat="server" OnClick="LinkButtonUpdateGateway_Click" Text="<%$ Resources:StringDef,UpdateGateway %>" />						
		</td>
	</tr>
</table>
</ContentTemplate>
...
<table width="100%">
    ...
    <tr>
        <td>
            <asp:Table ID="TableGatewayInfo" runat="server" />
        </td>
    </tr>
</table>
</ContentTemplate>
