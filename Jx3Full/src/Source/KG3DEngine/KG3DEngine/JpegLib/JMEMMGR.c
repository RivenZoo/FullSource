...
struct jvirt_sarray_control {
  ...
  boolean_def pre_zero;		/* pre-zero mode requested? */
  boolean_def dirty;		/* do current buffer contents need written? */
  boolean_def b_s_open;		/* is backing-store data valid? */
...
request_virt_sarray (j_common_ptr cinfo, int pool_id, boolean_def pre_zero,
		     JDIMENSION samplesperrow, JDIMENSION numrows,
...
request_virt_barray (j_common_ptr cinfo, int pool_id, boolean_def pre_zero,
		     JDIMENSION blocksperrow, JDIMENSION numrows,
		     JDIMENSION maxaccess)
...
LOCAL(void)
do_sarray_io (j_common_ptr cinfo, jvirt_sarray_ptr ptr, boolean_def writing)
...
LOCAL(void)
do_barray_io (j_common_ptr cinfo, jvirt_barray_ptr ptr, boolean_def writing)
