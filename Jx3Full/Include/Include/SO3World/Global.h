...
#define OPEN_BOX            "OpenBox"               // 开箱子, Param1:player Param2:dwBox Param3:dwPos
...
#define MAX_ACHIEVEMENT_ID 2000
...
enum KITEM_EXIST_TYPE
{
    ...
    ketPermanent,        // 没有存在时间限制的道具
    ketOnLine,           // 在线一定时间消失的道具
    ketOffLine,          // 下线一定时间消失的道具
    ketOnlineAndOffLine  // 总存在一定时间消失的道具
};
