...
enum
{
    ...
    MODEL_RIDES_EQUIP_BODY = MODEL_RIDES_EQUIP_BEGIN,
    MODEL_RIDES_EQUIP_MANE,
    MODEL_RIDES_EQUIP_HEAD,
    MODEL_RIDES_EQUIP_CHEST,
    MODEL_RIDES_EQUIP_LEG,
...
enum
{
    ...
    MODEL_RIDES_SOCKET_PENDANT = MODEL_RIDES_SOCKET_BEGIN, 
...
public:
	...
	virtual HRESULT ExecuteCommand(LPCTSTR szCommand, void* pResult) = 0;
    ...
    virtual int GetCameraInitParams(
        int *pnCameraResetMode, float *pfCameraDragSpeed, float *pfCameraMaxDistance, float *pfCameraResetSpeed) = 0;
};
