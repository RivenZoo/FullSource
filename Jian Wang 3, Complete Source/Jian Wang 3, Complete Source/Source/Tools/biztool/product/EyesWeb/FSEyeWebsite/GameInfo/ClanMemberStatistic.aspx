<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameInfo_ClanMemberStatistic, App_Web_d99p0fdh" title="<%$ Resources:StringDef, SocialRelation %>" theme="BlazeSky" %>
