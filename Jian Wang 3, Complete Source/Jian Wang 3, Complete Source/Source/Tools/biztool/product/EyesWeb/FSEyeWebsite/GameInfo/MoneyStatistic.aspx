<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameInfo_MoneyStatistic, App_Web_d99p0fdh" maintainscrollpositiononpostback="true" title="<%$ Resources:StringDef, MoneyStatistic %>" theme="BlazeSky" %>
