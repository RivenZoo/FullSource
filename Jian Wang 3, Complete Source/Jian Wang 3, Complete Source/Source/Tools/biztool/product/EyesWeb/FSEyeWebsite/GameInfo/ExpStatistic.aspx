<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameInfo_ExpStatistic, App_Web_d99p0fdh" title="<%$ Resources:StringDef, ExpStatistic %>" theme="BlazeSky" %>
