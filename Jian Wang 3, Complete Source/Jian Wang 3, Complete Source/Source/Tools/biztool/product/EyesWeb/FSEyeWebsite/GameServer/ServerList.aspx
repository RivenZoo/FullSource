<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_ServerList, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, GameServerList %>" theme="BlazeSky" %>
