<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Paysys_AccountInfo, App_Web_ipk8xfvi" title="<%$ Resources: StringDef, AccountInfo %>" theme="BlazeSky" %>
