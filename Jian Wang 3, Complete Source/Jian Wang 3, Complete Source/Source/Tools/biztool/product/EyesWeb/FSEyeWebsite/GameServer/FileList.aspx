<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_FileList, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, FileList %>" theme="BlazeSky" %>
