<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameMaster_PlayerMonitor, App_Web_6lmf-asn" title="<%$ Resources:StringDef, PlayerMonitor %>" theme="BlazeSky" %>
