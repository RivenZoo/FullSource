<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_DeleteServer, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, RemoveServer %>" theme="BlazeSky" %>
