<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_PlugInConfig, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, PlugInConfig %>" theme="BlazeSky" %>
