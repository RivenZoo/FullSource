<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameInfo_ActivePlayerStatistic, App_Web_d99p0fdh" title="<%$ Resources:StringDef,ActivePlayer %>" theme="BlazeSky" %>
	...
	<tr>
        <td align="center">
			<asp:Table ID="Table1" runat="server">
            	...
            	<asp:TableRow>
				    <asp:TableHeaderCell>
				        <asp:Literal ID="Literal31" runat="server" Text="Àà±ð" />
				    </asp:TableHeaderCell>
				    <asp:TableCell>
