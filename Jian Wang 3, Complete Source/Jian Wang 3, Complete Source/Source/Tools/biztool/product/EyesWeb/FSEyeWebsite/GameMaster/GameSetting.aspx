<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameMaster_GameSetting, App_Web_6lmf-asn" title="<%$ Resources:StringDef, GameSetting %>" theme="BlazeSky" %>
