<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Customization_cabinet, App_Web_t6cqrgfr" title="<%$ Resources:StringDef,Cabinet %>" theme="BlazeSky" %>
