<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_StrategyList, App_Web_4eiilbni" title="<%$ Resources:StringDef, StrategyList %>" theme="BlazeSky" %>
