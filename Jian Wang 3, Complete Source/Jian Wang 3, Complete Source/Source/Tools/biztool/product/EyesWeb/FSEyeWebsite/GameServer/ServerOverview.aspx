<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="GameServer_ServerOverview, App_Web_jvyc5ygz" title="<%$ Resources:StringDef, ServerOverview %>" theme="BlazeSky" %>
