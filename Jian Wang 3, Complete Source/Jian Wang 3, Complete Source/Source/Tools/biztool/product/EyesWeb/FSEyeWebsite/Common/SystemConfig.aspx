<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Common_SystemConfig, App_Web_ygkqysx-" title="<%$ Resources:StringDef, SystemConfig %>" theme="BlazeSky" %>
