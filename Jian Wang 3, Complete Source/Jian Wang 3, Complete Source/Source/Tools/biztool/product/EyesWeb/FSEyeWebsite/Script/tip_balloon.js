...
config. BalloonImgPath = "../Image/tip_balloon/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
// Sizes of balloon images
config. BalloonEdgeSize = 12		// Integer - sidelength of quadratic corner images
