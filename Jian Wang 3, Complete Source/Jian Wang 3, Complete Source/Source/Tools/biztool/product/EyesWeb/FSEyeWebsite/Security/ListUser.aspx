<%@ page language="C#" masterpagefile="~/Common/Main.master" autoeventwireup="true" inherits="Security_ListUser, App_Web_jztwgtrl" title="<%$ Resources:StringDef, User %>" theme="BlazeSky" %>
