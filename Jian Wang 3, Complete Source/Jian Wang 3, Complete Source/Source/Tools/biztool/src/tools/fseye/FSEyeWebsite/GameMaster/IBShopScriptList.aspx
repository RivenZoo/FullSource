<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="IBShopScriptList.aspx.cs" Inherits="GameMaster_IBShopScriptList" Title="<%$ Resources:StringDef,IBShopScriptList %>" %>
