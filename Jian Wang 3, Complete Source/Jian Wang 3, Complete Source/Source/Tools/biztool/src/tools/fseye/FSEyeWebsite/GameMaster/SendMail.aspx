<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="SendMail.aspx.cs" Inherits="GameMaster_SendMail" Title="<%$ Resources:StringDef,SendMail %>" %>
