<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="EditGroup.aspx.cs" Inherits="Security_EditGroup" Title="<%$ Resources:StringDef, EditGroup %>" %>
