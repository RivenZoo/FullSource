<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AddAlertCondition.aspx.cs" Inherits="GameServer_AddAlertCondition" Title="<%$ Resources:StringDef, AddAlertCondition %>" %>
