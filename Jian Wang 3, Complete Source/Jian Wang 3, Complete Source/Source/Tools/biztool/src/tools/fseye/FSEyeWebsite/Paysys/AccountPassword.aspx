<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AccountPassword.aspx.cs" Inherits="Paysys_AccountPassword" Title="<%$ Resources: StringDef, AccountPassword %>" %>
