<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AlertConfig.aspx.cs" Inherits="GameServer_AlertConfig" Title="<%$ Resources:StringDef, AlertConfig %>" %>
