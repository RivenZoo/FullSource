<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="ChatMonitor.aspx.cs" Inherits="GameMaster_ChatMonitor" Title="<%$ Resources:StringDef,ChatMonitor %>" %>
