<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="ItemBank.aspx.cs" Inherits="GameMaster_ItemBank" Title="<%$ Resources:StringDef,ItemBank %>" %>
