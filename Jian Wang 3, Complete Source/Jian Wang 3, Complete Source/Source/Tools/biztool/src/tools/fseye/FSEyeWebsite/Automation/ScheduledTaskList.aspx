<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="ScheduledTaskList.aspx.cs" Inherits="Automation_ScheduledTaskList" Title="<%$ Resources:StringDef, ScheduledTaskList %>" %>
