<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="SocialRelationStatistic.aspx.cs" Inherits="GameInfo_SocialRelationStatistic" Title="<%$ Resources:StringDef, SocialRelation %>" %>
