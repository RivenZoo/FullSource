<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="EditServer.aspx.cs" Inherits="GameServer_EditServer" Title="<%$ Resources:StringDef, EditServer %>" %>
