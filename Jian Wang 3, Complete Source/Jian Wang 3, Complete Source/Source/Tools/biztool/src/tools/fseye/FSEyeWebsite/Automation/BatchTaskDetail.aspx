<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="BatchTaskDetail.aspx.cs" Inherits="Automation_BatchTaskDetail" Title="<%$ Resources:StringDef, BatchTaskDetail %>" %>
