<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AuctionStatistic.aspx.cs" Inherits="GameInfo_Auction" %>
...
<table width="100%">
	<tr>
		<td align="center" colspan="4">
			<asp:Label ID="literal3" runat="server" Text="<%$ Resources:StringDef, Auction %>" SkinID="Title" />
		</td>
	</tr>
...
<table width="100%">
	...
	<tr>
		<td>
		<asp:Table ID="TableSearchResult" runat="server">
			<asp:TableHeaderRow>
				<asp:TableHeaderCell><asp:Literal ID="literal6" runat="server" Text="<%$ Resources:StringDef,ItemName %>" /></asp:TableHeaderCell>
				<asp:TableHeaderCell><asp:Literal ID="literal7" runat="server" Text="拍卖次数" /></asp:TableHeaderCell>
				<asp:TableHeaderCell><asp:Literal ID="literal71" runat="server" Text="所占比例" /></asp:TableHeaderCell>
			</asp:TableHeaderRow>
		</asp:Table>
		</td>
	</tr>
