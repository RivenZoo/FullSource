<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="EasyStatistic.aspx.cs" Inherits="GameInfo_EasyStatistic" Title="<%$ Resources:StringDef, EasyStatistic %>" %>
