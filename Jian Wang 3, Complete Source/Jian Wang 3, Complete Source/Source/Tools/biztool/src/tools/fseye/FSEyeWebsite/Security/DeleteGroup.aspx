<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="DeleteGroup.aspx.cs" Inherits="Security_DeleteGroup" Title="<%$ Resources:StringDef, DeleteGroup %>" %>
