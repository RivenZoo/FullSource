<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AddStrategy.aspx.cs" Inherits="GameServer_AddStrategy" Title="<%$ Resources:StringDef, AddStrategy %>" %>
