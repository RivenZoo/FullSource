<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="NpcDeathStatistic.aspx.cs" Inherits="GameInfo_NpcDeathStatistic" Title="<%$ Resources:StringDef, NpcDeath %>" %>
