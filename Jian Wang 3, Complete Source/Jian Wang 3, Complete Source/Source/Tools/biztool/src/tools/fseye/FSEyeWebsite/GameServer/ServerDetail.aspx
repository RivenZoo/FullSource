<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="ServerDetail.aspx.cs" Inherits="GameServer_ServerDetail" Title="<%$ Resources:StringDef, ServerDetail %>" MaintainScrollPositionOnPostback="true" %>
