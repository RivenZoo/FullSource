<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="PlayerWho.aspx.cs" Inherits="GameMaster_PlayerWho" Title="<%$ Resources:StringDef, OnlinePlayer %>" %>
