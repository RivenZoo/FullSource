...
; * 
; * $Id: mp3_win.asm,v 1.1 2007/07/30 02:03:53 huchangyin Exp $
; */
...
GLOBAL _window_mpg_asm
GLOBAL _window_dual_asm
GLOBAL _window16_asm
GLOBAL _window16_dual_asm
GLOBAL _window8_asm
GLOBAL _window8_dual_asm
